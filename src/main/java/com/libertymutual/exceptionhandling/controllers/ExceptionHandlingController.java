package com.libertymutual.exceptionhandling.controllers;
...
public class ExceptionHandlingController {
	    ...
	    public ModelAndView handleString(String probablySomeText) {
	        ...
	        } catch (IndexOutOfBoundsException ile) {
	        	mv.addObject("stringResult", "please enter at least four characters");
	       }
	        return mv;
	    }
	    ...
	    public ModelAndView handleInteger(String probablyAnInteger) {
	        ...
	        try {
	        	...
	        	mv.addObject("integerResult", "please enter an integer");
	        }
	    ...
	    public ModelAndView handleDecimal(String probablyADecimal) {
	        ...
	        try {
	        	...
	        	mv.addObject("decimalResult", "please enter a decimal");
	        }
	    ...
	    public ModelAndView handleDate(String probablyADate) {
	        ...
	        try {
	        	...
	        	mv.addObject("dateResult", "please enter a date");
	        }
	    ...
	    public ModelAndView handleUrl(String probablyAUrl) throws MalformedURLException {
	      ...
	      try {  
	        mv.addObject("urlResult", new URL(probablyAUrl));
	    	 ...
	    	 mv.addObject("urlFailure", "please enter a URL");
	      }
	        return mv;
	    }  
